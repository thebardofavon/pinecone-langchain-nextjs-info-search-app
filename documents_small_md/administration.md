...
![banner](https://www.iiitg.ac.in/uploads/2023/05/02/3b734fdd680ec4fc1d4e36872e347df7.webp){.img-fluid
...
-   [Director]{#home-tab_6 .get-adm type="button"
    data-for="administration" catid="6" slug="administration/director"
    true\"=""}
-   [Registrar]{#home-tab_7 .get-adm type="button"
    data-for="administration" catid="7" slug="administration/registrar"
    false\"=""}
-   [Deans]{#home-tab_8 .get-adm type="button" data-for="administration"
    catid="8" slug="administration/deans" false\"=""}
-   [Board of IIITG]{#home-tab_9 .get-adm type="button"
    data-for="administration" catid="9"
    slug="administration/board-of-iiitg" false\"=""}
-   [Senate]{#home-tab_10 .get-adm type="button"
    data-for="administration" catid="10" slug="administration/senate"
    false\"=""}
-   [Finance Committee]{#home-tab_11 .get-adm type="button"
    data-for="administration" catid="11" slug="administration/finance"
    false\"=""}
-   [Building and works]{#home-tab_12 .get-adm type="button"
    data-for="administration" catid="12"
    slug="administration/building-and-works" false\"=""}
-   [Staff]{#home-tab_40 .get-adm type="button"
    data-for="administration" catid="40" slug="administration/staff-1"
    false\"=""}
:::
:::

::: {#nav-tabContent .tab-content}
::: {#tab40 .tab-pane .fade .show .active role="tabpanel" aria-labelledby="home-tab_40"}
::: {#adm-content}
::: admini-row
::: {#dmModal56 .modal .fade tabindex="-1" aria-labelledby="dmModal56Label" aria-hidden="true"}
::: modal-dialog
::: modal-content
::: modal-header
##### Prof.Gautam Barua {#dmModal56Label .modal-title}
:::
...
width="311px" height="352px"}
:::

::: card-body
##### Prof.Gautam Barua {#prof.gautam-barua}

Professor (CSE) PhD (UCSB)

<div>

[Read More](https://www.iiitg.ac.in/from-the-directors-desk){.btn
.btn-outline-secondary .btn-sm .rounded-pill .ps-3 .pe-3}
