...
::: {role="main"}
::: {.section .courses-section1}
::: container
The Department of Computer Science and Engineering offers Bachelor,
Masters and PhD. degrees. For the UG and PG programmes, a student has to
successfully complete the designated courses within a particular
duration of time. For PhD. the student is required to complete the
course work and research work ideally within a period of 4 to 5 years .
...
Master of Technology in Computer Science and Engineering (2 years)
:::
...
::: courses-row
::: item
![](https://cygnusdvlp.in/iiit-guwahati/uploads/2023/04/11/645b91520a7dd466cfbb6da70bd3fee6.png){.img-fluid}
:::

::: item
#### Under graduate curriculum for CSE
...
possibilities of relating IT with these subjects. Curriculum of B. Tech
(CSE) has been designed to make the students as industry ready. Hence it
includes the CSE courses with a thrust on recent industry requirements
such as AI/ML, Data Analytics, Blockchain, Internet of Things (IoT) etc.
There are numerous elective courses floated in CSE, which enables the
students to opt for the professional career as per their career goal.
There are also a lot of emphasis on cutting-edge research areas, which
can enable the students to choose a career in higher studies.
...
to the third week of July. First year courses are common for both CSE &
ECE. This gives flexibility to students for branch change after the
first year. After the first year common program, the second year program
will be relatively fixed, comprising mostly of core courses for the
program. 3rd year onwards the program will be more flexible comprising
of electives, which may be organized as streams. There is one HSS course
every semester, for a total of eight courses. Courses in Physics (2),
Chemistry, and Biology are taught from Semester III onwards.

For knowing more about the UG curriculum [click here]()
:::
:::
:::

::: {.section .courses-section3}
::: courses-row
::: item
#### Post graduate curriculum for CSE

The programme is designed to create innovators and researchers in core
areas of computer science. Students are expertized in fields of CSE like
...
and development requirements of industry and academia. To make the
student industry ready, the curriculum consists of the course with a
thrust on recent industry requirements such as AI/ML, Data Analytics,
Blockchain, Natural Language Processing (NLP), Internet of Things (IoT)
etc. Students can choose from a numerous elective course, floated in
CSE, which opens several options for them to advance their career as per
their career goals. The M. Tech programme includes a year long thesis
work, where a lot of emphasis is given on cutting-edge research areas.
This can enable the students to take up R & D assignments in industries
or opt for a research position on their completion.

For knowing more about the PG curriculum [click here]()
:::

::: item
![](https://cygnusdvlp.in/iiit-guwahati/uploads/2023/04/11/fa62c865f4fe4f0ad7c4b8a0dd8195ca.jpg){.img-fluid}
:::
:::
:::
:::
