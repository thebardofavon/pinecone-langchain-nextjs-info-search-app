...
![banner](https://www.iiitg.ac.in/uploads/2023/10/07/0d605d912f2bcf36001f46aa2d575ec5.jpg){.img-fluid
width="1920px" height="343px"}
:::

::: {role="main"}
::: {#ilv4 .container .py-5}
#### M.Tech. Programme in Electronics and Communication Engineering {#ipkd .border-buttom .pb-2}

Specializations:

-   Communication and Signal Processing \[Offered both in Online/Remote
    Mode and On-campus Mode\]
-   \(2\) VLSI and Embedded System \[Offered only in On-campus Mode\])

::: {.card .mt-4}
::: {.card-header .bg-primary}
##### Important Dates {#important-dates-1 .card-title .text-white}
:::

::: card-body
The relevant dates related to M.Tech admission are as follows.

  Event                                       Date
  ------------------------------------------- -----------------------------------------------
  Last Date for Receiving Applications        25th June, 2023 (Sunday)
  Online Interview/ Written Test/ Interview   07-07-2023 (Friday) and 08-07-2023 (Saturday)
  Commencement of Classes                     1st August, 2023 (Tuesday)(Tentative)
:::
:::
:::
:::
