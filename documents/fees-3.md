...
![banner](https://www.iiitg.ac.in/uploads/2023/10/07/4b3d9bbe8f6046c14860789d76f4a86a.jpg){.img-fluid
...
::: {.section .py-5}
::: container
#### M.Tech Programme in Computer Science and Engineering (On-Campus) {#m.tech-programme-in-computer-science-and-engineering-on-campus .text-center .py-3 .border-bottom}

::: {.card .bg-info .shadow .p-3 .mb-5 .bg-body .rounded}
::: card-header
##### Fees
:::

::: card-body
When admission is offered and accepted by a candidate, he/she has to pay
the fee (details is below) using the online payment facility available
on the website.

This is a self-financed course and all students have to pay the full
fees as given in table below. Fees are payable before the beginning of
every semester. There will be no increase in the fees during the
programme even if there is an increase for new students.

  Serial No.      Items                      Periodicity             Amount (in Rs.)
  --------------- -------------------------- ----------------------- -----------------
  1               Tuition Fee                Per Semester            1,00,000
  2               Institute Caution Money    One Time (Refundable)   5000
  3               Hostel Rent                Per Semester            12,500
  4               Mess Charges (estimated)   Per semester            16000
  Hosteller                                                          1,33,500
  Non-Hosteller                                                      1,05,000

Please note that mess charges can vary depending on inflation and other
factors. Mess charges will be charged extra during winter and summer
vacations if students avail mess facilities. The mess advance collected
will be adjusted against bills.
