...
::: project-row
::: item
#### Machine learning-based computational models for the analysis of monsoon activities over the Indian region at temporal and spatial scale\"

PI: Dr. Parashjyoti Borah
...
::: item
#### Design and Development of an Assistive Device for Persons with Motor Neuron Disease

PI: Dr. Rakesh Matam

Co-PI : Dr. Kaustuv Nag

Sponsoring Agency: SEED (DST), Govt. of India

Current Status: Ongoing
:::

::: item
#### Design and Innovation Centre Spoke for \'Internet of Things

PI: Dr. Ferdous Ahmed Barbhuiya
...
::: item
#### Security and Privacy Preserved Automatic Health Emergency Detection and MSP Selection in IoT Based Smart Healthcare System

PI: Dr. Subhasish Dhal
...
::: item
#### Service Caching architecture for edge networks

PI: Dr. Radhika Sukapuram
...
::: item
#### Periocular Biometrics on AR/VR Devices

PI: Dr. Ferdous Ahmed Barbhuiya

Sponsoring Agency: IBM-IRL

Current Status: Completed
:::

::: item
#### Adaptive learning models for land-cover classification with application in remote sensing based monitoring of agriculture and forestry

PI: Dr. Moumita Roy

Sponsoring Agency: ECR scheme / SERB (DST)

Current Status: Completed
:::

::: item
#### On performance of structural damage detection based on: mathematical and machine-learning models in harmony, and domain adaptation with scaled physical model using limited sensors
...
physical model using limited sensors

Co-PI: Dr. Moumita Roy
...
::: item
#### Design of Structure Preserving Deep Neural Networks for Improved Generalization
...
::: item
#### Efficient Execution of User Applications on Mobile Edge Computing Platform

PI: Dr. Manojit Ghose

Sponsoring Agency: MHRD/TEQIP

Current Status: Completed
:::

::: item
#### Development of MAC associated schemes for large IEEE 802.15.4 based Networks
...
::: item
#### Design of training course-ware and feasibility study of zero trust approach under InstaSafe framework

PI: Dr. Srinibas Swain

Sponsoring Agency: Industry project for InstaSafe

Current Status: Completed
:::

::: item
#### A Secure and Scalable Inter-cloud Authorization framework for resource sharing in Cloud Environment
