...
::: {.section .faculty-recruitment-section}
::: container
::: {.col-lg-6 .m-auto}
::: {.card .mt-5}
##### **Sign In** {#sign-in .card-header .bg-info .text-center .py-4 .text-white}

::: card-body
::: mb-2
[![](https://www.iiitg.ac.in/design/front/assets/images/google-signin-button.png){.img-fluid
style="max-width:400px;"}](https://accounts.google.com/o/oauth2/v2/auth?response_type=code&access_type=online&client_id=844093230841-ucmooh7pa8nssktuh9p35h0flkbmqdk8.apps.googleusercontent.com&redirect_uri=https%3A%2F%2Fwww.iiitg.ac.in%2Ffaculty%2Fgmail_login&state&scope=email%20profile&approval_prompt=auto){style="color: white;text-decoration: none;text-align: center;width: 100%;float: left;"}
:::
:::
:::
:::
