...
![banner](https://www.iiitg.ac.in/uploads/2023/08/05/ef947548a7d3c45ea21cd891a373b4d4.webp){.img-fluid}
:::

::: {role="main"}
::: {#i8x1 .section .the-section .py-5}
::: {#ix0o .container}
::: {#ipul .section .bdg-sect}
# Google Developer Students\' Club (GDSC) {#islg .heading}

The IIITG Google Developer Student Club (GDSC) is a dynamic student
organization at the Indian Institute of Information Technology Guwahati
(IIITG), recognized by Google. The club aims to empower students with
the latest tech skills and foster innovation and collaboration. GDSC
hosts workshops, webinars, and coding sessions on Google technologies
and cutting-edge developments.

It promotes a vibrant community of tech enthusiasts, encouraging
knowledge sharing and collaboration on real-world projects. Guest
lectures by industry professionals and Google experts expose challenges
and potential career paths. The club actively participates in Google-led
initiatives, enhancing employability in the tech job market. IIITG GDSC
is an inclusive community welcoming students with diverse expertise and
backgrounds. It offers a supportive environment for all members to learn
and grow in the ever-evolving tech landscape.

![](https://www.iiitg.ac.in/uploads/2023/08/05/20e3b14ce6d06b96610a3e655648ec31.png){#ivze
.img-fluid}
:::
:::
:::
