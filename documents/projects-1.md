...
::: {role="main"}
::: {.section .electric-ongoing-projects}
::: container
## Ongoing Projects

::: projects-row
::: item
\"SERB project on \"Effects of Nonpharmaceutical Measures on COVID-19
Pandemic in India and Network-based Forecast Beyond Relaxation of
Lockdown\", **Dr. Surajit Panja**
:::

::: item
\"SERB project on \"Control-Theoretic Distributed Optimal Resource
Allocation Approaches to Hinder Epidemic Spreading over Networks and Its
Forecasting for Indian Cities \", **Dr. Surajit Panja**
:::
...
::: item
\"A Low coast, High Resolution Optoacoustic Imaging System for
Diagnosing and Monitoring Rheumatoid Arthritis\", **Dr. Rusha Patra**
:::

::: item
\"A Low-cost, portable telepathology lab to perform routine microscopic
tests in rural areas towards the improvement of healthcare system\",
**Dr. Rusha Patra**
:::

::: item
\"A Low Cost, Portable and High Quality Device (Prototype) For Food
Quality Assessment Based On Microscopic Image and Deep Learning\", **Dr.
Shovan Barma**
:::

::: item
\"Detection and Forecasting of Extreme Weather Events in Egypt and India
using Deep Learning\", **Dr. Shovan Barma**
:::

::: item
SERB project on \"Signal Processing for Co-existence between Radar and
Future Communication Systems\", **Dr. Sudip Biswas**
:::

::: item
\"Reconfigurable 3DIC Hardware Accelerator Platform for Deep Neural
Networks \", **Dr. Soumyajit Poddar**
:::
:::
:::
:::

::: {.section .electric-completed-projects}
::: container
## Completed Projects

::: projects-row
::: item
To establish a low-cost, portable telepathology lab to perform routine
microscopic tests in rural areas towards the improvement of healthcare
system. DBT, 2018-2019., **Dr. Rusha Patra**
:::

::: item
\"Classification of EEG Data Using Deep Learning (LSTM+CNN) Technique
and Hilbert Vibration Decomposition (HVD) Method and Its Application in
Epilepsy\", **Dr. Shovan Barma**
:::
:::
:::
:::
