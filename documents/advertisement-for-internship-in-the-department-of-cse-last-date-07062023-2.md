...
::: title
::: container
# Advertisement for Internship in the Department of CSE. Last date 07.06.2023
:::
:::
...
#### Advertisement for Internship {#advertisement-for-internship .text-center}

Applications are invited for 1 (one) month internship programme in
Computer Science & Engineering (CSE) under a research project with the
following details:

  Sl No   Area                                           Project Title                                                                                                                             Duration   Assistantship
  ------- ---------------------------------------------- ----------------------------------------------------------------------------------------------------------------------------------------- ---------- -------------------
  1       Artificial Intelligence, Atmospheric Science   Machine learning-based computational models for the analysis of monsoon activities over the Indian region at temporal and spatial scale   1 month    Rs.5000/per month
...
1.  Last date of receiving application: 07-06-2023.
2.  Date of Selection (Online Interview): 10-06-2023 (Tentative).
3.  Date of Commencement: 16-06-2023 (Tentative)

##### APPLICATION PROCEDURE

Interested candidates are requested to email their CV to
<parashjyoti.borah@iiitg.ac.in> .

\*The internship is in offline mode and the student will have to attend
in physically. In case hostel accommodation/mess service is required,
the selected candidate needs to pay the hostel rent/mess fees.

For any query and further information, please contact Dr. Parashjyoti
Borah (<parashjyoti.borah@iiitg.ac.in>).
:::
:::
:::
:::
