...
![banner](https://www.iiitg.ac.in/uploads/2023/10/07/8943bfa2eeefc0984f0ec5fa34b43b12.jpg){.img-fluid
...
::: {#ic3j .container .py-5}
#### [[M.Tech Programme in Computer Science and Engineering (On-Campus)]{xss="removed"}]{xss="removed"} {#ixag .text-center .py-4 .border-bottom .border-top}

::: {#it3w draggable="true"}
::: {#ik8l .card .shadow-lg .p-3 .mb-5 .bg-body .rounded draggable="true"}
::: {#igbm3 .card-body draggable="true"}
To enable students to pursue their dream of higher education, IIIT
Guwahati is offering an M.Tech programme in CSE with a curriculum
designed to create industry-ready professionals. We invite students to
join us on our exciting journey of learning.
:::
:::
...
-   [Industry-focused and research-driven curriculum designed for the
    graduates from CS/IT background.]{#iqcli}
-   [State-of-the-art lab facilities for conducting cutting-edge
    research.]{#izzfk}
-   [A number of Electives to choose from.]{#iqe2r}
-   [Internship option as the final semester project.]{#idlxi}
-   [Complete placement assistance and guidance for higher
    studies.]{#ioowu}
-   [Industry-academia collaborative projects.]{#ifb1e}
:::
:::

::: {#ihbth .card .shadow-lg .p-3 .mb-5 .bg-body .rounded draggable="true"}
::: {#ig5nk .card-header draggable="true"}
##### M.Tech 2023 Admissions {#iap0n .text-center draggable="true"}
:::

::: {#ixh09 .card-body draggable="true"}
IIIT Guwahati welcomes prospective students for admission into the
M.Tech CSE programme. This is an On-Campus programme where the students
have to attend classes physically on campus. Physical presence on campus
enables a student to be in an academic environment which results in a
tremendous increase in learning outside the classroom. Fresh graduates
...
::: card-header
##### Important Information for Prospective Students {#important-information-for-prospective-students .text-center}
:::

::: card-body
1.  The syllabi are designed focusing on AI, ML, and Big Data.
2.  The program is designed for students with different academic
    backgrounds
3.  Different elective options in CS courses to supplement students with
    non-CS backgrounds.
4.  Use of Learning Management System to conduct interactive online
    classes, archiving lectures, assignments, online discussions, etc.
5.  Lectures and labs will be conducted online according to the Time
    Table.
6.  The examination will be conducted online via proctored mode.
:::
:::
:::
:::
