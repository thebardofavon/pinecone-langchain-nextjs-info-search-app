...
![banner](https://www.iiitg.ac.in/uploads/2023/08/07/6f64dcb062011b4c098dc9b89352de0e.webp){.img-fluid}
:::

::: {role="main"}
::: {#it4s .section .the-section .py-5}
::: {#in1n .container .py-5}
::: {#izgq .section .bdg-sect}
The Welfare Board is one of the four boards under the Student Gymkhana
Council, IIIT Guwahati. Presently, there are three clubs under the
Welfare Board. The clubs share the responsibility of conducting events
and spreading awareness for the physical and mental well-being of the
student community. The three clubs under the Welfare Board are:
:::
...
The activities of the Welfare Board are spread across the whole academic
year. The clubs host several events including but not limited to Blood
Donation camps, Yoga Sessions, Vaccination Camps, Tree Plantation, so on
and so forth.
:::
:::
:::
