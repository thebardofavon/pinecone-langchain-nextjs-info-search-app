...
![banner](https://www.iiitg.ac.in/uploads/2023/08/05/21cada737a848b001faa5264d9b123c8.webp){.img-fluid}
:::

::: {role="main"}
::: {#iwsy .section .the-section .py-5}
::: {#iel1 .container}
::: {#ixyz .gjs-row .gap-5}
::: {#iw3j .gjs-cell}
::: {#iujj .section .bdg-sect}
# Programming Club {#ivxu .heading .pb-3}

The IIITG Programming Club is a vibrant student organization at the
Indian Institute of Information Technology Guwahati (IIITG), fostering a
passion for coding and software development among its members. Through
workshops, coding competitions, and collaborative projects, the club
empowers students to enhance their coding skills and thrive in
technology. The inclusive environment welcomes students of all skill
levels, providing a supportive space for learning and growth. Guest
lectures by industry experts offer valuable insights into the latest
trends and industry practices, preparing members for real-world
challenges. With a focus on teamwork and innovation, the IIITG
Programming Club creates a dynamic programming culture on campus,
nurturing technical excellence and a spirit of exploration in the
ever-evolving programming field.
:::
:::

::: {#isrg .gjs-cell}
![](https://www.iiitg.ac.in/uploads/2023/08/05/8531f8637d48546363ce3b1e3f97feb1.jpeg){#iqmm
.img-fluid}
:::
:::
:::
