...
![banner](https://www.iiitg.ac.in/uploads/2023/10/06/d15e7023cdb574715a4a925ec60270af.jpg){.img-fluid
width="1920px" height="343px"}
:::

::: {role="main"}
::: {#ihwv .section .the-section .py-5}
::: {#irtw .container .py-5}
#  {#imcg .heading .border-bottom .pb-2 .cke_editable .cke_editable_inline .cke_contents_ltr .cke_show_borders}

# M.Tech. Programme in Electronics and Communication Engineering {#ijqd .heading .cke_editable .cke_editable_inline .cke_contents_ltr .border-bottom .pb-2 .gjs-selected .cke_show_borders .cke_focus draggable="false" spellcheck="false" xss="removed"}

::: {#i0d3 .section .bdg-sect}
:::

::: {#ixgq}
[**Specializations:**]{xss="removed"}
:::
...
::: {#ineq .gjs-row .card}
::: {#ieu6w .gjs-cell .mt-4}
::: {#iw6d5 .gjs-row .card-body}
::: {#i9bra .gjs-cell .card}
::: {#ibjio .section .bdg-sect}
# Application Process {#ibgev .heading}

<div>

Applications are invited for admission to the Master of Technology
(M.Tech) programmes starting in August 2023. There is no application
fee.
...
Form (the link is provided below):
...
-   Application form along with the self-attested copies of all degrees,
    mark sheets and certificates (class X onward) must be uploaded
    through the application link.
-   GATE/NET score is not mandatory. However if GATE/NET score is
    available it may be uploaded using the same Google form link.
-   The application form (other than Annexures) should be filled in the
    provided Word File template and converted to pdf before uploading.
-   These are fully self-financed program and no scholarship will be
    provided.
:::

::: {#i7gfz}
[Links for Online Application and Application Form]{xss="removed"}
:::

::: {#i8lyh .gjs-row .gap-5 .col-md-5 .mt-4 draggable="true"}
::: {#iewiy .gjs-cell draggable="true"}
[Apply
Online](https://docs.google.com/forms/d/e/1FAIpQLSeUah__6PgOionIHqiG2Oi3QGfo1PiaYKdgM0muEPjWb0dE-A/viewform){#ibbty
.btn .btn-outline-light .w-100 .py-3 .btn-primary draggable="true"
target="_blank"}
:::

::: {#iu6k7 .gjs-cell draggable="true"}
[Application
Form](https://www.iiitg.ac.in/uploads/files/M.Tech_app_form_2023.docx){#ih9fs
.btn .w-100 .py-3 .btn-outline-light .btn-primary draggable="true"
target="_blank"}
:::
:::
...
::: {#iuo1m}
-   Shortlisted candidates will be called for online interview by email.
-   The details of online interview will be mentioned in the call letter
    sent via mail. There may be a written test too, and if there is, it
    will be mentioned in the call letter.
-   The selected students will have to pay the first semester requisite
    fees on due time after declaration of result in order to reserve
    their seat.
-   Wait-listed candidates will be offered the seat if any seat remains
    vacant due to non-payment of fees.
:::
:::
:::
:::
