...
![banner](https://www.iiitg.ac.in/uploads/2023/08/25/4fe4860b2212ee833b4eacb1af95bbe4.jpg){.img-fluid}
:::

::: {role="main"}
::: {#iqlj .container .py-5}
::: {#i2ap .section .bdg-sect}
# **[Advertisement for Internship]{xss="removed"}** {#i8ec .heading .text-center}

[Applications are invited for 2 (two) months internship programme in
Computer Science & Engineering (CSE) under a research project with the
following details:]{xss="removed"}
:::

::: {#iusu}
  SL No.   Area                   Project Title                                                                                                                Duration   Assistantship
  -------- ---------------------- ---------------------------------------------------------------------------------------------------------------------------- ---------- -------------------
  1        Information Security   Security and Privacy Preserved Automatic Health Emergency Detection and MSP Selection in IoT Based Smart Healthcare System   2 months   Rs.5000/per month
:::

::: {#i7z6v .section .the-section .py-5}
::: {#io58q .section .bdg-sect}
#### **ELIGIBILITY**

1.  Students in undergraduate engineering or postgraduate science in
    relevant discipline.
:::

::: {#if3lc .section .bdg-sect}
#### [IMPORTANT DATES]{xss="removed"}

1.  Last date of receiving application: [07-09-2023.]{xss="removed"}
2.  [Date of Selection (Online
    Interview): [15-09-2023]{xss="removed"} (Tentative)]{xss="removed"}[.]{xss="removed"}
3.  Date of
    Commencement: [20-09-2023]{xss="removed"} (Tentative),​​​​​​​[]{xss="removed"}
:::

::: {#iomx2 .section .bdg-sect}
#### **APPLICATION PROCEDURE**

[Interested candidates are requested to email their CV to
subhasis@iiitg.ac.in]{xss="removed"}[](mailto:parashjyoti.borah@iiitg.ac.in)[ .\
​​​​​​​]{xss="removed"}[For any query and further information, please
contact ]{xss="removed"}[Dr.]{.SpellE xss="removed"}[ Subhasish Dhal
(subhasis@iiitg.ac.in).]{xss="removed"}[\
\
]{xss="removed"}\
:::
:::
