...
![banner](https://www.iiitg.ac.in/uploads/2023/10/07/0dca2005436a9d792547cd5bc64fd7f5.jpg){.img-fluid
width="1920px" height="343px"}
:::

::: {role="main"}
::: {.container .py-5}
#### M.Tech Programme in Computer Science and Engineering (Online) {#i294 .py-3 .text-center .border-bottom}

::: {.card .bg-info .shadow .p-3 .mb-5 .bg-body .rounded}
::: card-header
##### Contact {#contact-1 .text-center}
:::

::: card-body
In case you have further queries, you can contact the following person

Dr. Parashjyoti Borah\
Department of CSE\
[(parashjyoti.borah@iiitg.ac.in)](mailto:parashjyoti.borah@iiitg.ac.in)
:::
:::
:::
:::
